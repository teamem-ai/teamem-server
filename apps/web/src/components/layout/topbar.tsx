...
export function Topbar() {
  ...
  return (
    <header className="h-topbar border-b border-border bg-bg flex items-center gap-[10px] px-6 sticky top-0 z-30">
      ...
      <span className="inline-flex items-center gap-[7px] font-semibold text-[13.5px] py-[6px] px-[10px] text-text max-w-[220px] truncate">
        <span
      ...
      <div className="relative" ref={projectMenuRef}>
        <button
          className="switcher inline-flex items-center gap-[7px] font-semibold text-[13.5px] py-[6px] px-[10px] rounded-sm cursor-pointer text-text border border-transparent hover:bg-surface-2 max-w-[220px] transition-colors"
      ...
      <button className="search-btn hidden sm:inline-flex items-center gap-2 border border-border bg-surface text-text-3 rounded-sm py-[6px] px-[10px] text-[13px] cursor-pointer min-w-[200px] hover:border-border-strong transition-colors">
