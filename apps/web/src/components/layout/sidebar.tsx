...
export function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-sidebar bg-surface border-r border-border flex flex-col z-40 lg:static lg:w-full lg:border-r-0 lg:border-b">
      {/* Brand */}
